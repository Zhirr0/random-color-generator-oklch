import { oklchToString, getTextColor, generateLighterShades, getClosestColorName } from "../utils/colorUtils"

export default function LighterPage({ baseColor, onCopy, onToggleSave, isSaved }) {
  if (!baseColor) return null
  const shades = generateLighterShades(baseColor)
  ...
  return (
    <div className="page shade-page">
      <div className="shade-info">
        ...
        <div>
          <span className="section-tag">lighter shades</span>
